<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductPage.aspx.cs" Inherits="ZenGaming.ProductPage" %>
 ...
 <header class="text-gray-600 body-font">
  <link href="https://unpkg.com/tailwindcss@^2/dist/tailwind.min.css" rel="stylesheet" />
    ...
    <nav class="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
      ...
      <a href="Sale.aspx" class="mr-5 hover:text-gray-900">Sale</a>
    ...
    <a class="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
      ...
      <span class="ml-3 text-xl">Zen Gaming</span>
    </a>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Playstation 5</h1>
        <div class="flex mb-4">
        ...
        <div class="flex">
          ...
          <button class="flex ml-auto text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded">Add to Wish List</button>
...
<%--        <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-10 h-10 text-white p-2 bg-green-500 rounded-full" viewBox="0 0 24 24">--%>
    ...
    <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Catalogue</h2>
        <nav class="list-none mb-10">
          <li>
            <a href="Homepage.aspx" class="text-gray-600 hover:text-gray-800">All Products</a>
          </li>
          <li>
            <a href="FeaturedProducts.aspx" class="text-gray-600 hover:text-gray-800">Featured Products</a>
          </li>
          <li>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Shipping Details</h2>
        <nav class="list-none mb-10">
          <li>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          <li>
            <a href="CustomerFeedback.aspx" class="text-gray-600 hover:text-gray-800">Customer Feedback</a>
          </li>
          <li>
  ...
  <div class="bg-gray-100">
    <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p class="text-gray-500 text-sm text-center sm:text-left">© 2021 Zen Gaming </p>
